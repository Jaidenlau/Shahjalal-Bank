...
export const MODULES: ModuleDef[] = [
  ...
  { no: 3, code: "INTEGRITY", name: "Procurement Integrity", href: "/integrity", group: "Procurement", tier: "full", perm: "INTEGRITY",
    beyondScope: true,
    blurb: "Seven continuous tests over procurement the Bank already records \u2014 split purchases, price drift, supplier concentration, bid clustering, repeat winners, approvals nobody read, and tenders that drew a single bid." },
